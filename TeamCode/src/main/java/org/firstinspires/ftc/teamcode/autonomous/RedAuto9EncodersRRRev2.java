...
@Config
@Autonomous(name="Red Close 9 (RR) [Before]", group="Autonomous")
public class RedAuto9EncodersRRRev2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder driveToGet3 = drive.actionBuilder(new Pose2d(-12,12,(Math.toRadians(135))))
                .strafeToLinearHeading(new Vector2d(5,57.5),Math.toRadians(90))
                .waitSeconds(0.75)
                .strafeToLinearHeading(new Vector2d(21,12),Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(21,60),Math.toRadians(90));

        TrajectoryActionBuilder driveTo3 = drive.actionBuilder(new Pose2d(21,60,(Math.toRadians(90))))
