...
@Config
@Autonomous(name="Blue Close 9 (RR) [Before]", group="Autonomous")
public class BlueAuto9EncodersRRRev2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder driveToGet3 = drive.actionBuilder(new Pose2d(-12,-12,(Math.toRadians(-142))))
                ...
                .waitSeconds(0.75)
                .strafeToLinearHeading(new Vector2d(18,-24),Math.toRadians(-90))
                .strafeToLinearHeading(new Vector2d(18,-67),Math.toRadians(-90));

        TrajectoryActionBuilder driveTo3 = drive.actionBuilder(new Pose2d(18,-67,(Math.toRadians(-90))))
